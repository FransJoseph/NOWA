...
--
-- Host: 127.0.0.1
-- Generation Time: Maj 27, 2025 at 12:05 PM
...
CREATE TABLE `pochowki` (
  `id` int(5) NOT NULL,
  `zmarly_id` int(5) NOT NULL,
  `grob_id` int(5) NOT NULL,
...
INSERT INTO `pochowki` (`id`, `zmarly_id`, `grob_id`, `data_pochowku`, `rodzaj_pochowku`, `notka_pochowku`) VALUES
(15, 1, 1, '0000-00-00', '', ''),
(16, 1, 1, '2025-05-09', 'ziemny', 'asdasd');
...
ALTER TABLE `pochowki`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id osoby` (`zmarly_id`,`grob_id`),
  ADD KEY `id grobu` (`grob_id`);
...
--
ALTER TABLE `pochowki`
  ADD CONSTRAINT `pochowki_ibfk_1` FOREIGN KEY (`zmarly_id`) REFERENCES `zmarli` (`id`),
  ADD CONSTRAINT `pochowki_ibfk_2` FOREIGN KEY (`grob_id`) REFERENCES `groby` (`id`);
COMMIT;
